...
namespace acmedesktop.DataTransaction.Purchase
{
    public partial class FrmPurchaseReturn : Form
    {
        ...
        string _ChallanNo = "";
        IPurchaseReturn _objPurchaseReturn = new clsPurchaseReturn();
        ...
        public FrmPurchaseReturn()
        {
            ...
            _IsSaveAndPrint = _objDocPrintSetting.CheckIsSaveAndPrint("PR");
        ...
        {
            DocPrintingOption frm = new DocPrintingOption("PR", "Purchase Return", "");
            frm.ShowDialog();
            frm.Dispose();
        }
        ...
        private void BtnVoucherNoSearch_Click(object sender, EventArgs e)
        {
            ...
            PickList frmPickList = new PickList("PurchaseReturnVoucher", _SearchKey);
            if (PickList.dt.Rows.Count > 0)
            {
                ...
                if (frmPickList.SelectedList.Count > 0 && _Tag != "NEW")
                {
                    ...
                    DataSet ds = _objPurchaseReturn.GetDataPurchaseReturnVoucher(_VoucherNo);
                    ClearFld();
                    SetData(ds);
                }
                frmPickList.Dispose();
        ...
        private void TxtVoucherNo_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            if (_Tag == "NEW")
            {
                if (!string.IsNullOrEmpty(_objPurchaseReturn.IsExistsVNumber(TxtVoucherNo.Text)))
                {
			...
			else
			{
				if (this._VoucherNo != TxtVoucherNo.Text.Trim())
				{
					...
					DataSet ds = _objPurchaseReturn.GetDataPurchaseReturnVoucher(this._VoucherNo);
					ClearFld();
					SetData(ds);
				}
			}
        ...
        {
            FrmUDFMasterEntry frm = new FrmUDFMasterEntry("Purchase Master Global", _VoucherNo, "PR");
            frm.ShowDialog();
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            if (_NetAmt < 0)
            {
                MessageBox.Show("Purchase return invoice negative should not be save.", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                BtnOk.Focus();
                return;
            }
            ...
            _objPurchaseReturn.Model.EntryFromProject = "Normal";
            _objPurchaseReturn.Model.Gadget = "Desktop";
            _objPurchaseReturn.Model.ReferenceNo = TxtRefBillNo.Text;
            _objPurchaseReturn.Model.ReferenceDate = Refdate;
            _objPurchaseReturn.Model.ReferenceMiti = Refmiti;

            _objPurchaseReturn.Model.PartyName = TxtVendor.Text;
            _objPurchaseReturn.Model.TaxableAmount = 0;
            _objPurchaseReturn.Model.TaxFreeAmount = 0;
            _objPurchaseReturn.Model.VatAmount = 0;
            _objPurchaseReturn.Model.ChequeDate = null;
            _objPurchaseReturn.Model.UdfDetails = ClsGlobal.UDFExistingDataTableDetails;
            _objPurchaseReturn.Model.UdfMaster = ClsGlobal.UDFExistingDataMaster;
            _objPurchaseReturn.Model.VDate = Convert.ToDateTime(TxtDate.Text);
            _objPurchaseReturn.Model.Tag = _Tag;
            ...
            if (_Tag == "NEW")
            {
                ...
                _objPurchaseReturn.Model.DocId = ((TxtVoucherNo.Tag.ToString() == "") ? 0 : Convert.ToInt32(TxtVoucherNo.Tag.ToString()));
                _objPurchaseReturn.Model.VoucherNo = (!string.IsNullOrEmpty(VoucherNoDetails[0])) ? VoucherNoDetails[0] : TxtVoucherNo.Text.Trim();
            }
            else
                _objPurchaseReturn.Model.VoucherNo = TxtVoucherNo.Text.Trim();

            _objPurchaseReturn.Model.VTime = _objDate.GetServerDateTime();
            _objPurchaseReturn.Model.VMiti = TxtMiti.Text;
            _objPurchaseReturn.Model.LedgerId = Convert.ToInt32(TxtVendor.Tag.ToString());


            _objPurchaseReturn.Model.DueMiti = "";
            _objPurchaseReturn.Model.InvoiceType = "";


            _objPurchaseReturn.Model.SalesmanId = Convert.ToInt32(TxtSalesman.Tag.ToString());

            if (!string.IsNullOrEmpty(TxtDepartment.Text))
            {
                string[] dept = TxtDepartment.Tag.ToString().Split('|');
                _objPurchaseReturn.Model.DepartmentId1 = ((dept[0].ToString() == "") ? 0 : Convert.ToInt32(dept[0].ToString()));
                _objPurchaseReturn.Model.DepartmentId2 = ((dept[1].ToString() == "") ? 0 : Convert.ToInt32(dept[1].ToString()));
                _objPurchaseReturn.Model.DepartmentId3 = ((dept[2].ToString() == "") ? 0 : Convert.ToInt32(dept[2].ToString()));
                _objPurchaseReturn.Model.DepartmentId4 = ((dept[3].ToString() == "") ? 0 : Convert.ToInt32(dept[3].ToString()));
            }
            _objPurchaseReturn.Model.BranchId = ClsGlobal.BranchId;
            _objPurchaseReturn.Model.CompanyUnitId = ClsGlobal.CompanyUnitId;
            if (!string.IsNullOrEmpty(TxtCurrency.Tag.ToString()))
            {

                _objPurchaseReturn.Model.CurrencyId = Convert.ToInt32(TxtCurrency.Tag.ToString());
            }
            _objPurchaseReturn.Model.CurrencyRate = _CurrencyRate;
            decimal.TryParse(LblBasicAmt.Text.Trim(), out decimal BasicAmt);
            _objPurchaseReturn.Model.BasicAmount = BasicAmt;
            decimal.TryParse(TxtBillTermAmt.Text.Trim(), out decimal TermAmt);
            _objPurchaseReturn.Model.TermAmount = TermAmt;
            decimal.TryParse(LblNetAmt.Text.Trim(), out decimal NetAmt);
            _objPurchaseReturn.Model.NetAmount = NetAmt;
            decimal.TryParse(LblNetAmt.Text.Trim(), out decimal localNetAmount);
            _objPurchaseReturn.Model.LocalNetAmount = localNetAmount;
            _objPurchaseReturn.Model.SubLedgerId = Convert.ToInt32(TxtSubledger.Tag.ToString());


            if (!string.IsNullOrEmpty(TxtBillingAddress.Text.ToString().Trim()))
            {
                _objPurchaseReturn.ModelBillAddress.LedgerId = Convert.ToInt32(TxtVendor.Tag.ToString());
                _objPurchaseReturn.ModelBillAddress.BillingAddress = TxtBillingAddress.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.BillingCity = TxtBillingCity.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.BillingState = TxtBillingState.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.BillingCountry = TxtBillingCountry.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.BillingEmail = TxtBillingEmail.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.ShippingAddress = TxtShippingAddress.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.ShippingCity = TxtShippingCity.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.ShippingState = TxtShippingState.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.ShippingCountry = TxtShippingCountry.Text.Trim();
                _objPurchaseReturn.ModelBillAddress.ShippingEmail = TxtShippingEmail.Text.Trim();
            }
            _objPurchaseReturn.Model.PartyName = !string.IsNullOrEmpty(CashPartyViewModel.PartyName) ? CashPartyViewModel.PartyName : TxtVendor.Text.Trim();
            _objPurchaseReturn.Model.PartyAddress = CashPartyViewModel.PartyAddress;
            _objPurchaseReturn.Model.PartyVatNo = CashPartyViewModel.PartyVatNo;
            if (!string.IsNullOrEmpty(CashPartyViewModel.ChequeNo))
            {
                _objPurchaseReturn.Model.ChequeNo = CashPartyViewModel.ChequeNo;
                _objPurchaseReturn.Model.ChequeDate = Convert.ToDateTime(CashPartyViewModel.ChequeDate);
                _objPurchaseReturn.Model.ChequeMiti = null;
            }
            else
            {
                _objPurchaseReturn.Model.ChequeNo = null;
                _objPurchaseReturn.Model.ChequeDate = null;
                _objPurchaseReturn.Model.ChequeMiti = null;
            }
            _objPurchaseReturn.Model.PartyMobileNo = CashPartyViewModel.PartyMobileNo;
            _objPurchaseReturn.Model.PartyEmail = CashPartyViewModel.PartyEmail;

            _objPurchaseReturn.ModelOtherDetails.Transport = TxtTransport.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.VehicleNo = TxtVehicleNo.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.Package = TxtPackage.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.CnNo = TxtCnNo.Text.Trim();

            if (TxtCnDate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objPurchaseReturn.ModelOtherDetails.CnDate = _objDate.GetDate(TxtCnDate.Text);
                else
                    _objPurchaseReturn.ModelOtherDetails.CnDate = Convert.ToDateTime(TxtCnDate.Text);
            }
            else
                _objPurchaseReturn.ModelOtherDetails.CnDate = null;

            _objPurchaseReturn.ModelOtherDetails.CnFreight = TxtCnFreight.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.Advance = TxtAdvance.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.BalFreight = TxtBalFreight.Text.Trim();

            if (CmbCnType.Text == "Due")
            {
                _objPurchaseReturn.ModelOtherDetails.CnType = "D";
            }
            else if (CmbCnType.Text == "To Pay")
            {
                _objPurchaseReturn.ModelOtherDetails.CnType = "T";
            }
            else if (CmbCnType.Text == "Paid")
            {
                _objPurchaseReturn.ModelOtherDetails.CnType = "P";
            }
            else if (CmbCnType.Text == "Free")
            {
                _objPurchaseReturn.ModelOtherDetails.CnType = "F";
            }
            else if (CmbCnType.Text == "")
            {
                _objPurchaseReturn.ModelOtherDetails.CnType = null;
            }
            _objPurchaseReturn.ModelOtherDetails.DriverName = TxtDriverName.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.DriverLicNo = TxtDriverLicenseNo.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.DriverMobileNo = TxtDriverMobileNo.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.ContractNo = TxtContactNo.Text.Trim();
            if (TxtContactDate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objPurchaseReturn.ModelOtherDetails.ContractDate = _objDate.GetDate(TxtContactDate.Text);
                else
                    _objPurchaseReturn.ModelOtherDetails.ContractDate = Convert.ToDateTime(TxtContactDate.Text);
            }
            else
                _objPurchaseReturn.ModelOtherDetails.ContractDate = null;

            _objPurchaseReturn.ModelOtherDetails.ExpInvNo = TxtExportInvNo.Text.Trim();

            if (TxtExportInvDate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objPurchaseReturn.ModelOtherDetails.ExpInvDate = _objDate.GetDate(TxtExportInvDate.Text);
                else
                    _objPurchaseReturn.ModelOtherDetails.ExpInvDate = Convert.ToDateTime(TxtExportInvDate.Text);
            }
            else
                _objPurchaseReturn.ModelOtherDetails.ExpInvDate = null;

            _objPurchaseReturn.ModelOtherDetails.PoNo = TxtPONo.Text.Trim();

            if (TxtPODate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objPurchaseReturn.ModelOtherDetails.PoDate = _objDate.GetDate(TxtPODate.Text);
                else
                    _objPurchaseReturn.ModelOtherDetails.PoDate = Convert.ToDateTime(TxtPODate.Text);
            }
            else
                _objPurchaseReturn.ModelOtherDetails.PoDate = null;

            _objPurchaseReturn.ModelOtherDetails.DocBank = TxtDocBank.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.LcNo = TxtLCNo.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.CustomName = TxtCustomerName.Text.Trim();
            _objPurchaseReturn.ModelOtherDetails.Cofd = TxtCoFd.Text.Trim();

            PurchaseInvoiceReturnDetailsViewModel _PurchaseReturnDetails = null;
            ...
            foreach (DataGridViewRow ro in Grid.Rows)
            {
                ...
                {
                    _PurchaseReturnDetails = new PurchaseInvoiceReturnDetailsViewModel();
                    _PurchaseReturnDetails.VoucherNo = _objPurchaseReturn.Model.VoucherNo;
                    _PurchaseReturnDetails.Sno = Grid.Rows.IndexOf(ro) + 1;
                    _PurchaseReturnDetails.ProductId = Convert.ToInt32(ro.Cells["ProductId"].Value.ToString());

                    if (ro.Cells["GodownId"].Value != null)
                        _PurchaseReturnDetails.GodownId = string.IsNullOrEmpty(ro.Cells["GodownId"].Value.ToString()) ? 0 : Convert.ToInt32(ro.Cells["GodownId"].Value.ToString());
                    else
                        _PurchaseReturnDetails.GodownId = 0;

                    if (ro.Cells["AltQty"].Value != null)
                    {
                        decimal.TryParse(ro.Cells["AltQty"].Value.ToString().Trim(), out decimal _AltQty);
                        _PurchaseReturnDetails.AltQty = _AltQty;
                    }
                    else
                        _PurchaseReturnDetails.AltQty = 0;
                    if (ro.Cells["AltQty"].Value != null)
                    {
                        _PurchaseReturnDetails.ProductAltUnitId = !string.IsNullOrEmpty(ro.Cells["ProductAltUnitId"].Value.ToString()) ? Convert.ToInt32(ro.Cells["ProductAltUnitId"].Value.ToString()) : 0;
                    }

                    _PurchaseReturnDetails.Qty = ro.Cells["Qty"].Value != null ? Convert.ToDecimal(ro.Cells["Qty"].Value.ToString().Trim()) : 0;

                    if (ro.Cells["ProductUnitId"].Value != null)
                        _PurchaseReturnDetails.ProductUnitId = string.IsNullOrEmpty(ro.Cells["ProductUnitId"].Value.ToString()) ? 0 : Convert.ToInt32(ro.Cells["ProductUnitId"].Value.ToString());
                    else
                        _PurchaseReturnDetails.ProductUnitId = 0;


                    _PurchaseReturnDetails.StockQuantity = ro.Cells["Qty"].Value != null ? Convert.ToDecimal(ro.Cells["Qty"].Value.ToString().Trim()) : 0;
                    if (ro.Cells["AltQty"].Value != null)
                    {
                        decimal.TryParse(ro.Cells["AltQty"].Value.ToString().Trim(), out decimal _AltStockQty);
                        _PurchaseReturnDetails.AltStockQuantity = _AltStockQty;
                    }
                    else
                        _PurchaseReturnDetails.AltStockQuantity = 0;
                    _PurchaseReturnDetails.ConversionRatio = ro.Cells["QtyConversion"].Value != null ? Convert.ToDecimal(ro.Cells["QtyConversion"].Value.ToString().Trim()) : 0;
                    _PurchaseReturnDetails.PurchaseRate = ro.Cells["Rate"].Value != null ? Convert.ToDecimal(ro.Cells["Rate"].Value.ToString().Trim()) : 0;
                    _PurchaseReturnDetails.StockValue = _PurchaseReturnDetails.StockQuantity * _PurchaseReturnDetails.PurchaseRate;
                    _PurchaseReturnDetails.BasicAmount = ro.Cells["BasicAmt"].Value != null ? Convert.ToDecimal(ro.Cells["BasicAmt"].Value.ToString().Trim()) : 0;
                    _PurchaseReturnDetails.TermAmount = ro.Cells["TermsAmt"].Value != null ? Convert.ToDecimal(ro.Cells["TermsAmt"].Value.ToString().Trim()) : 0;
                    _PurchaseReturnDetails.NetAmount = ro.Cells["NetAmt"].Value != null ? Convert.ToDecimal(ro.Cells["NetAmt"].Value.ToString().Trim()) : 0;
                    if (ro.Cells["OrderSNo"].Value != null)
                        _PurchaseReturnDetails.OrderSNo = ro.Cells["OrderSNo"].Value != null ? Convert.ToInt32(ro.Cells["OrderSNo"].Value.ToString().Trim()) : 0;
                    else
                        _PurchaseReturnDetails.OrderSNo = 0;
                    _PurchaseReturnDetails.OrderNo = ro.Cells["OrderNo"].Value?.ToString().Trim();
                    if (ro.Cells["ChallanSNo"].Value != null)
                        _PurchaseReturnDetails.ChallanSNo = ro.Cells["ChallanSNo"].Value != null ? Convert.ToInt32(ro.Cells["ChallanSNo"].Value.ToString().Trim()) : 0;
                    else
                        _PurchaseReturnDetails.ChallanSNo = 0;
                    _PurchaseReturnDetails.ChallanNo = ro.Cells["ChallanNo"].Value?.ToString().Trim();

                    if (ro.Cells["PurchaseInvoiceSNo"].Value != null)
                        _PurchaseReturnDetails.PurchaseInvoiceSNo = ro.Cells["PurchaseInvoiceSNo"].Value != null ? Convert.ToInt32(ro.Cells["PurchaseInvoiceSNo"].Value.ToString().Trim()) : 0;
                    else
                        _PurchaseReturnDetails.PurchaseInvoiceSNo = 0;
                    _PurchaseReturnDetails.PurchaseInvoiceNo = ro.Cells["PurchaseInvoiceNo"].Value?.ToString().Trim();

                    _PurchaseReturnDetails.AdditionalDesc = ro.Cells["AdditionalDesc"].Value != null ? ro.Cells["AdditionalDesc"].Value.ToString() : ro.Cells["Particular"].Value.ToString().Trim();
                    _PurchaseReturnDetails.FreeQty = 0;
                    _objPurchaseReturn.ModelDetails.Add(_PurchaseReturnDetails);
                    ...
                    if (ro.Cells["TermDetails"].Value != null)
                    {
                        if (!string.IsNullOrEmpty(ro.Cells["TermDetails"].Value.ToString()))
                        {
                            ...
                            for (int i = 0; i < termCodeArr.Count(); i++)
                            {
                                ...
                                _objPurchaseReturn.ModelTerms.Add(_PurchaseInvoiceTerm);
                            }
                        }
                    }
                }
            ...
            if (!string.IsNullOrEmpty(TxtBillTermAmt.Tag.ToString().Trim()))
            {
                ...
                if (val2.Length > 1)
                {
                    ...
                    {
                        _PurchaseInvoiceTerm = new TermViewModel();
                        _PurchaseInvoiceTerm.VoucherNo = _objPurchaseReturn.Model.VoucherNo;
            ...
            _objPurchaseReturn.Model.DocId = Convert.ToInt32(TxtVoucherNo.Tag.ToString());
            string output = _objPurchaseReturn.SavePurchaseReturn();
        ...
        {
            Common.PickList frmPickList = new Common.PickList("PurchaseVoucherForPurchaseReturn", _SearchKey);
            if (Common.PickList.dt.Rows.Count > 0)
            {
                frmPickList.ShowDialog();
                if (frmPickList.SelectedList.Count > 0)
        ...
        private void TxtRefBillNo_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                    DataSet ds = _objPurchaseReturn.GetDataPurchaseInvoiceVoucherDataToReturn(TxtRefBillNo.Text.Trim(), TxtVoucherNo.Text );
                    Grid.Rows.Clear();
                    Grid.Rows.Add();
                    Grid.Enabled = true;
                    SetRefBillData(ds);
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            {
                Utility.GetVoucherNo1("Purchase Return", TxtVoucherNo, TxtDate, _Tag, "");
            }
            else if (TxtRefBillNo.Enabled == true)
            {
                Utility.GetVoucherNo2("Purchase Return", TxtVoucherNo, TxtRefBillNo, _Tag, "");
            }
            else
            {
                Utility.GetVoucherNo1("Purchase Return", TxtVoucherNo, TxtDate, _Tag, "");
        ...
        private void SetRefBillData(DataSet ds)
        {
            ...
            foreach (DataRow drDetails in dtDetails.Rows)
            {
                ...
                Grid.Rows[Grid.Rows.Count - 1].Cells["AltStockQty"].Value = ClsGlobal.DecimalFormate(Convert.ToDecimal(drDetails["AltQty"].ToString()), 1, ClsGlobal._AltQtyDecimalFormat).ToString();
                Grid.Rows[Grid.Rows.Count - 1].Cells["StockQty"].Value = ClsGlobal.DecimalFormate(Convert.ToDecimal(drDetails["Qty"].ToString()), 1, ClsGlobal._QtyDecimalFormat).ToString();
                Grid.Rows[Grid.Rows.Count - 1].Cells["PurchaseInvoiceNo"].Value = TxtRefBillNo.Text;
                Grid.Rows[Grid.Rows.Count - 1].Cells["PurchaseInvoiceSNo"].Value = Grid.Rows.Count.ToString();
