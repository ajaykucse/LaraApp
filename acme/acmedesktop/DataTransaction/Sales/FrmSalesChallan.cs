...
{
    public partial class FrmSalesChallan : Form
    {
		...
		ISalesChallan _objSalesChallan = new ClsSalesChallan();
        ...
        public FrmSalesChallan()
        {
            ...
            _IsSaveAndPrint = _objDocPrintSetting.CheckIsSaveAndPrint("SC");
        }
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            {
                Utility.GetVoucherNo1("Sales Challan", TxtVoucherNo, TxtDate, _Tag, "", _DocId);
            }
			else if (TxtOrderNo.Enabled == true)
            {
                Utility.GetVoucherNo2("Sales Challan", TxtVoucherNo, TxtOrderNo, _Tag, "", _DocId);
            }
			else if (TxtQuotationNo.Enabled == true)
			{
				Utility.GetVoucherNo2("Sales Challan", TxtVoucherNo, TxtQuotationNo, _Tag, "", _DocId);
			}
			else
            {
                Utility.GetVoucherNo2("Sales Challan", TxtVoucherNo, TxtCustomer, _Tag, "", _DocId);
            }
        }
        ...
        {
            PickList frmPickList = new PickList("SalesChallanVoucher", _SearchKey);
            if (PickList.dt.Rows.Count > 0)
            {
                ...
                if (frmPickList.SelectedList.Count > 0 && _Tag != "NEW")
                {
                    ...
                    DataSet ds = _objSalesChallan.GetDataSalesChallanVoucher(_VoucherNo);
                    SetData(ds);
                }
                frmPickList.Dispose();
            }
        ...
        private void TxtVoucherNo_Validating(object sender, CancelEventArgs e)
        {
			...
			if (_Tag == "NEW")
			{
				if (!string.IsNullOrEmpty(_objSalesChallan.IsExistsVNumber(TxtVoucherNo.Text)))
				{
				...
				else
				{
					...
					if (this._VoucherNo != TxtVoucherNo.Text.Trim())
					{
						this._VoucherNo = TxtVoucherNo.Text.Trim();
						 ds = _objSalesChallan.GetDataSalesChallanVoucher(this._VoucherNo);
						ClearFld();
						SetData(ds);
					}

					string _vno2 = _objSalesChallan.IsChallanUsedInBill(TxtVoucherNo.Text);
        ...
        private void TxtOrderNo_Validating(object sender, CancelEventArgs e)
        {
			...
			if (!string.IsNullOrEmpty(TxtOrderNo.Text.Trim()))
			{
				...
				//{
					Grid.Rows.Clear();
					Grid.Rows.Add();
					DataSet ds = _objSalesOrder.GetDataOrderForSales(TxtOrderNo.Text.Trim(),TxtVoucherNo.Text ,"SC");
        ...
        private void TxtBillTermAmt_Validating(object sender, CancelEventArgs e)
        {
            BtnOk.Enabled = true;
        }
        ...
        private void FrmSalesChallan_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void GetUDFMasterDataforQuotation()
        {
            string[] ss = { };
        ...
        private void BtnUDF_Click(object sender, EventArgs e)
        {
            ...
            if (_Tag == "NEW" && !string.IsNullOrEmpty(TxtQuotationNo.Text))
            {
                GetUDFMasterDataforQuotation();
            }
		...
		private void TxtQuotationNo_Validating(object sender, CancelEventArgs e)
		{
			...
			if (!string.IsNullOrEmpty(TxtQuotationNo.Text.Trim()))
			{
				...
				//{
					Grid.Rows.Clear();
					Grid.Rows.Add();
					DataSet ds = _objSalesQuotation.GetDataSalesQuotationForOrder(TxtQuotationNo.Text.Trim(),TxtVoucherNo.Text ,"SC");
        ...
        {
            DocPrintingOption frm = new DocPrintingOption("SC", "Sales Challan", "");
            frm.ShowDialog();
        }
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            _objSalesChallan.Model.Gadget = "Desktop";
            _objSalesChallan.Model.EnterBy = ClsGlobal.LoginUserCode;
            _objSalesChallan.Model.ReferenceNo = "";
            _objSalesChallan.Model.ReferenceDate = null;
            _objSalesChallan.Model.PartyName = TxtCustomer.Text;
            _objSalesChallan.Model.ReferenceMiti = "";
            _objSalesChallan.Model.ChequeNo = null;
            _objSalesChallan.Model.ChequeDate = null;
            _objSalesChallan.Model.ChequeMiti = null;
            _objSalesChallan.Model.UdfDetails = ClsGlobal.UDFExistingDataTableDetails;
            _objSalesChallan.Model.UdfMaster = ClsGlobal.UDFExistingDataMaster;
            _objSalesChallan.Model.VDate = Convert.ToDateTime(TxtDate.Text);
            _objSalesChallan.Model.Tag = _Tag;

            if (_Tag == "NEW")
            {
                string[] VoucherNoDetails = _objCommon.GetVoucherNo(TxtVoucherNo.Tag.ToString(), "Sales Challan", ClsGlobal.BranchId, ClsGlobal.CompanyUnitId);
                _objSalesChallan.Model.DocId = ((TxtVoucherNo.Tag.ToString() == "") ? 0 : Convert.ToInt32(TxtVoucherNo.Tag.ToString()));
                _objSalesChallan.Model.VoucherNo = (!string.IsNullOrEmpty(VoucherNoDetails[0])) ? VoucherNoDetails[0] : TxtVoucherNo.Text.Trim();
            }
			else
				_objSalesChallan.Model.VoucherNo = TxtVoucherNo.Text.Trim();

			_objSalesChallan.Model.VTime = _objDate.GetServerDateTime();
            _objSalesChallan.Model.VMiti = TxtMiti.Text;
            _objSalesChallan.Model.LedgerId = Convert.ToInt32(TxtCustomer.Tag.ToString());

            _objSalesChallan.Model.SalesmanId = Convert.ToInt32(TxtSalesman.Tag.ToString());

            if (!string.IsNullOrEmpty(TxtDepartment.Text))
            {
                string[] dept = TxtDepartment.Tag.ToString().Split('|');
                _objSalesChallan.Model.DepartmentId1 = ((dept[0].ToString() == "") ? 0 : Convert.ToInt32(dept[0].ToString()));
                _objSalesChallan.Model.DepartmentId2 = ((dept[1].ToString() == "") ? 0 : Convert.ToInt32(dept[1].ToString()));
                _objSalesChallan.Model.DepartmentId3 = ((dept[2].ToString() == "") ? 0 : Convert.ToInt32(dept[2].ToString()));
                _objSalesChallan.Model.DepartmentId4 = ((dept[3].ToString() == "") ? 0 : Convert.ToInt32(dept[3].ToString()));
            }
            _objSalesChallan.Model.BranchId = ClsGlobal.BranchId;
            _objSalesChallan.Model.CompanyUnitId = ClsGlobal.CompanyUnitId;
            _objSalesChallan.Model.CurrencyId = Convert.ToInt32(TxtCurrency.Tag.ToString());
            _objSalesChallan.Model.CurrencyRate = _CurrencyRate;

            decimal.TryParse(LblBasicAmt.Text.Trim(), out decimal BasicAmt);
            _objSalesChallan.Model.BasicAmount = BasicAmt;
            decimal.TryParse(TxtBillTermAmt.Text.Trim(), out decimal TermAmt);
            _objSalesChallan.Model.TermAmount = TermAmt;
            decimal.TryParse(LblNetAmt.Text.Trim(), out decimal NetAmt);
            _objSalesChallan.Model.NetAmount = NetAmt;

            _objSalesChallan.Model.SubLedgerId = Convert.ToInt32(TxtSubledger.Tag.ToString());
            _objSalesChallan.Model.OrderNo = TxtOrderNo.Text;
            _objSalesChallan.Model.QuotationNo = TxtQuotationNo.Text;
            _objSalesChallan.Model.Remarks = TxtRemarks.Text;

            if (!string.IsNullOrEmpty(TxtBillingAddress.Text.ToString().Trim()))
            {
                _objSalesChallan.ModelBillAddress.LedgerId = Convert.ToInt32(TxtCustomer.Tag.ToString());
                _objSalesChallan.ModelBillAddress.BillingAddress = TxtBillingAddress.Text.Trim();
                _objSalesChallan.ModelBillAddress.BillingCity = TxtBillingCity.Text.Trim();
                _objSalesChallan.ModelBillAddress.BillingState = TxtBillingState.Text.Trim();
                _objSalesChallan.ModelBillAddress.BillingCountry = TxtBillingCountry.Text.Trim();
                _objSalesChallan.ModelBillAddress.BillingEmail = TxtBillingEmail.Text.Trim();
                _objSalesChallan.ModelBillAddress.ShippingAddress = TxtShippingAddress.Text.Trim();
                _objSalesChallan.ModelBillAddress.ShippingCity = TxtShippingCity.Text.Trim();
                _objSalesChallan.ModelBillAddress.ShippingState = TxtShippingState.Text.Trim();
                _objSalesChallan.ModelBillAddress.ShippingCountry = TxtShippingCountry.Text.Trim();
                _objSalesChallan.ModelBillAddress.ShippingEmail = TxtShippingEmail.Text.Trim();
                //_objSalesInvoice.ModelBillAddress.Remarks = TxtRemarks.Text.Trim();
            }

			_objSalesChallan.Model.PartyName = !string.IsNullOrEmpty(CashPartyViewModel.PartyName) ? CashPartyViewModel.PartyName : TxtCustomer.Text.Trim();
			_objSalesChallan.Model.PartyAddress = CashPartyViewModel.PartyAddress;
			_objSalesChallan.Model.PartyVatNo = CashPartyViewModel.PartyVatNo;
			if (!string.IsNullOrEmpty(CashPartyViewModel.ChequeNo))
			{
				_objSalesChallan.Model.ChequeNo = CashPartyViewModel.ChequeNo;
				_objSalesChallan.Model.ChequeDate = Convert.ToDateTime(CashPartyViewModel.PartyVatNo);
				_objSalesChallan.Model.ChequeMiti = null;
			}
			else
			{
			...
			_objSalesChallan.Model.PartyMobileNo = CashPartyViewModel.PartyMobileNo;
			_objSalesChallan.Model.PartyEmail = CashPartyViewModel.PartyEmail;


			_objSalesChallan.ModelOtherDetails.Transport = TxtTransport.Text.Trim();
            _objSalesChallan.ModelOtherDetails.VehicleNo = TxtVehicleNo.Text.Trim();
            _objSalesChallan.ModelOtherDetails.Package = TxtPackage.Text.Trim();
            _objSalesChallan.ModelOtherDetails.CnNo = TxtCnNo.Text.Trim();

            if (TxtCnDate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objSalesChallan.ModelOtherDetails.CnDate = _objDate.GetDate(TxtCnDate.Text);
                else
                    _objSalesChallan.ModelOtherDetails.CnDate = Convert.ToDateTime(TxtCnDate.Text);
            }
            else
                _objSalesChallan.ModelOtherDetails.CnDate = null;

            _objSalesChallan.ModelOtherDetails.CnFreight = TxtCnFreight.Text.Trim();
            _objSalesChallan.ModelOtherDetails.Advance = TxtAdvance.Text.Trim();
            _objSalesChallan.ModelOtherDetails.BalFreight = TxtBalFreight.Text.Trim();

            if (CmbCnType.Text == "Due")
                _objSalesChallan.ModelOtherDetails.CnType = "D";
            else if (CmbCnType.Text == "To Pay")
                _objSalesChallan.ModelOtherDetails.CnType = "T";
            else if (CmbCnType.Text == "Paid")
                _objSalesChallan.ModelOtherDetails.CnType = "P";
            else if (CmbCnType.Text == "Free")
                _objSalesChallan.ModelOtherDetails.CnType = "F";
            else if (CmbCnType.Text == "")
                _objSalesChallan.ModelOtherDetails.CnType = null;
            _objSalesChallan.ModelOtherDetails.DriverName = TxtDriverName.Text.Trim();
            _objSalesChallan.ModelOtherDetails.DriverLicNo = TxtDriverLicenseNo.Text.Trim();
            _objSalesChallan.ModelOtherDetails.DriverMobileNo = TxtDriverMobileNo.Text.Trim();
            _objSalesChallan.ModelOtherDetails.ContractNo = TxtContactNo.Text.Trim();
            if (TxtContactDate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objSalesChallan.ModelOtherDetails.ContractDate = _objDate.GetDate(TxtContactDate.Text);
                else
                    _objSalesChallan.ModelOtherDetails.ContractDate = Convert.ToDateTime(TxtContactDate.Text);
            }
            else
                _objSalesChallan.ModelOtherDetails.ContractDate = null;

            _objSalesChallan.ModelOtherDetails.ExpInvNo = TxtExportInvNo.Text.Trim();

            if (TxtExportInvDate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objSalesChallan.ModelOtherDetails.ExpInvDate = _objDate.GetDate(TxtExportInvDate.Text);
                else
                    _objSalesChallan.ModelOtherDetails.ExpInvDate = Convert.ToDateTime(TxtExportInvDate.Text);
            }
            else
                _objSalesChallan.ModelOtherDetails.ExpInvDate = null;

            _objSalesChallan.ModelOtherDetails.PoNo = TxtPONo.Text.Trim();

            if (TxtPODate.Text != "  /  /")
            {
                if (ClsGlobal.DateType == "M")
                    _objSalesChallan.ModelOtherDetails.PoDate = _objDate.GetDate(TxtPODate.Text);
                else
                    _objSalesChallan.ModelOtherDetails.PoDate = Convert.ToDateTime(TxtPODate.Text);
            }
            else
                _objSalesChallan.ModelOtherDetails.PoDate = null;

            _objSalesChallan.ModelOtherDetails.DocBank = TxtDocBank.Text.Trim();
            _objSalesChallan.ModelOtherDetails.LcNo = TxtLCNo.Text.Trim();
            _objSalesChallan.ModelOtherDetails.CustomName = TxtCustomerName.Text.Trim();
            _objSalesChallan.ModelOtherDetails.Cofd = TxtCoFd.Text.Trim();

            SalesChallanDetailsViewModel _SalesChallanDetails = null;
            TermViewModel _SalesChallanTerm = null;
            ...
            foreach (DataGridViewRow ro in Grid.Rows)
            {
                ...
                {
                    _SalesChallanDetails = new SalesChallanDetailsViewModel();
                    _SalesChallanDetails.VoucherNo = _objSalesChallan.Model.VoucherNo;
                    _SalesChallanDetails.Sno = Grid.Rows.IndexOf(ro) + 1;
                    _SalesChallanDetails.ProductId = Convert.ToInt32(ro.Cells["ProductId"].Value.ToString());
                    if (ro.Cells["GodownId"].Value != null)
                        _SalesChallanDetails.GodownId = string.IsNullOrEmpty(ro.Cells["GodownId"].Value.ToString()) ? 0 : Convert.ToInt32(ro.Cells["GodownId"].Value.ToString());
                    else
                        _SalesChallanDetails.GodownId = 0;

                    _SalesChallanDetails.Qty = ro.Cells["Qty"].Value != null ? Convert.ToDecimal(ro.Cells["Qty"].Value.ToString().Trim()) : 0;
                    if (ro.Cells["ProductAltUnitId"].Value != null)
                        _SalesChallanDetails.ProductUnit = string.IsNullOrEmpty(ro.Cells["ProductUnitId"].Value.ToString()) ? 0 : Convert.ToInt32(ro.Cells["ProductUnitId"].Value.ToString());
                    else
                        _SalesChallanDetails.ProductAltUnit = 0;
                    if (ro.Cells["AltQty"].Value != null)
                    {
                        decimal.TryParse(ro.Cells["AltQty"].Value.ToString().Trim(), out decimal _AltQty);
                        _SalesChallanDetails.AltQty = _AltQty;
                    }
                    else
                    {
                        _SalesChallanDetails.AltQty = 0;
                    }

                    if (ro.Cells["ProductAltUnitId"].Value != null)
                        _SalesChallanDetails.ProductAltUnit = string.IsNullOrEmpty(ro.Cells["ProductAltUnitId"].Value.ToString()) ? 0 : Convert.ToInt32(ro.Cells["ProductAltUnitId"].Value.ToString());
                    else
                        _SalesChallanDetails.ProductAltUnit = 0;

                    _SalesChallanDetails.ConversionRatio = ro.Cells["QtyConversion"].Value != null ? Convert.ToDecimal(ro.Cells["QtyConversion"].Value.ToString().Trim()) : 0;
                    _SalesChallanDetails.SalesRate = ro.Cells["Rate"].Value != null ? Convert.ToDecimal(ro.Cells["Rate"].Value.ToString().Trim()) : 0;
                    _SalesChallanDetails.BasicAmount = ro.Cells["BasicAmt"].Value != null ? Convert.ToDecimal(ro.Cells["BasicAmt"].Value.ToString().Trim()) : 0;
                    _SalesChallanDetails.TermAmount = ro.Cells["TermsAmt"].Value != null ? Convert.ToDecimal(ro.Cells["TermsAmt"].Value.ToString().Trim()) : 0;
                    _SalesChallanDetails.NetAmount = ro.Cells["NetAmt"].Value != null ? Convert.ToDecimal(ro.Cells["NetAmt"].Value.ToString().Trim()) : 0;
					if (!string.IsNullOrEmpty(TxtOrderNo.Text.Trim()))
					{
						if (ro.Cells["OrderSNo"].Value != null)
							_SalesChallanDetails.OrderSNo = !string.IsNullOrEmpty(ro.Cells["OrderSNo"].Value.ToString()) ? Convert.ToInt32(ro.Cells["OrderSNo"].Value.ToString().Trim()) : 0;
						else
							_SalesChallanDetails.OrderSNo = 0;
						_SalesChallanDetails.OrderNo = ro.Cells["OrderNo"].Value?.ToString().Trim();
					}
					else
					{
						_SalesChallanDetails.OrderSNo = 0;
						_SalesChallanDetails.OrderNo = "";
					}
					if (!string.IsNullOrEmpty(TxtQuotationNo.Text.Trim()))
					{
						if (ro.Cells["QuotationSNo"].Value != null)
							_SalesChallanDetails.QuotationSNo = !string.IsNullOrEmpty(ro.Cells["QuotationSNo"].Value.ToString()) ? Convert.ToInt32(ro.Cells["QuotationSNo"].Value.ToString().Trim()) : 0;
						else
							_SalesChallanDetails.QuotationSNo = 0;
						_SalesChallanDetails.QuotationNo = ro.Cells["QuotationNo"].Value?.ToString().Trim();
					}
					else
					{
						_SalesChallanDetails.QuotationSNo = 0;
						_SalesChallanDetails.QuotationNo = "";
					}

					_SalesChallanDetails.AdditionalDesc = ro.Cells["AdditionalDesc"].Value != null ? ro.Cells["AdditionalDesc"].Value.ToString() : ro.Cells["Particular"].Value.ToString().Trim();
                    _SalesChallanDetails.FreeQty = 0;

                    _objSalesChallan.ModelDetails.Add(_SalesChallanDetails);
                    if (ro.Cells["TermDetails"].Value != null)
                    {
                        if (!string.IsNullOrEmpty(ro.Cells["TermDetails"].Value.ToString()))
                        {
                            ...
                            {
                                _SalesChallanTerm = new TermViewModel();
                                _SalesChallanTerm.VoucherNo = TxtVoucherNo.Text;
                                _SalesChallanTerm.TermId = Convert.ToInt32(termCodeArr[i]);
                                _SalesChallanTerm.Sno = Grid.Rows.IndexOf(ro) + 1;
                                _SalesChallanTerm.ProductId = Convert.ToInt32(ro.Cells["ProductId"].Value.ToString());
                                _SalesChallanTerm.STSign = termSignArr[i];
                                _SalesChallanTerm.TermType = "P";
                                _SalesChallanTerm.TermRate = Convert.ToDecimal(termRatePercentArr[i]);
                                _SalesChallanTerm.TermAmt = Convert.ToDecimal(termAmountntArr[i]);
                                _objSalesChallan.ModelTerms.Add(_SalesChallanTerm);
                            }
                        }
                    }
                }
            ...
            if (!string.IsNullOrEmpty(TxtBillTermAmt.Tag.ToString().Trim()))
            {
                ...
                {
                    _SalesChallanTerm = new TermViewModel();
                    _SalesChallanTerm.VoucherNo = _objSalesChallan.Model.VoucherNo;
                    _SalesChallanTerm.TermId = Convert.ToInt32(termCodeArr1[i]);
                    _SalesChallanTerm.Sno = 0;
                    _SalesChallanTerm.ProductId = 0;
                    _SalesChallanTerm.TermType = "B";
                    ...
                    _SalesChallanTerm.TermRate = _termRatePercentArr1;
                    _SalesChallanTerm.TermAmt = _termAmountArr1;
                    _SalesChallanTerm.STSign = termSignArr[i];
                    _objSalesChallan.ModelTerms.Add(_SalesChallanTerm);
                }
            }

            _objSalesChallan.Model.DocId = Convert.ToInt32(TxtVoucherNo.Tag.ToString());
            string output = _objSalesChallan.SaveSalesChallan();
