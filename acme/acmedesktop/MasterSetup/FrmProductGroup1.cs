...
{
    public partial class FrmProductGroup1 : Form
    {
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            Text = "Product Group1 [NEW]";
        }
        private void BtnEdit_Click(object sender, EventArgs e)
        {
            _Tag = "EDIT";
            ControlEnableDisable(false, true);
            Text = "Product Group1 [EDIT]";
        }
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            _Tag = "DELETE";
            ControlEnableDisable(false, false);
            Text = "Product Group1 [DELETE]";
        ...
        private void BtnFirstData_Click(object sender, EventArgs e)
        {
            if (NavMenuDataList.Rows.Count > 0)
            {
                ...
                DataTable dt = _objProductGroup.GetDataProductGroup(Convert.ToInt32(NavMenuDataList.Rows[NavMenuDataRowPosition]["ProductGrpId"].ToString()), "ProductGroup1");
                SetData(dt);
            }
            else
            {
        ...
        private void BtnSearchDesc_Click(object sender, EventArgs e)
        {
            ...
            if (Common.PickList.dt.Rows.Count > 0)
            {
                ...
                {
                    DataTable dt = _objProductGroup.GetDataProductGroup(Convert.ToInt32(frmPickList.SelectedList[0]["ProductGrpId"].ToString().Trim()), "ProductGroup1");
                    SetData(dt);
                    TxtDescription.SelectAll();
                }
                else
		...
		private void TxtDescription_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show("Group Description Cannot Left Blank...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                e.Cancel = true;
                return;
            }
            else if (_Tag == "NEW")
            {
                if (_objCommon.CheckDescriptionDuplicateRecord(TxtDescription.Text.Trim(), "ProductGroup1", "ProductGrpDesc", "ProductGrpId") == 1)
                {
                    MessageBox.Show("Group Description Already Exist...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    e.Cancel = true;
                    return;
                }
                else
                {
                    TxtShortName.Text = _objCommon.GenerateShortName(TxtDescription.Text.Trim(), "ProductGrpDesc", "ProductGrpShortName", "ProductGroup1");
                }
            }
            else if (_Tag == "EDIT")
            {
                if (_objCommon.CheckDescriptionDuplicateRecord(TxtDescription.Text.Trim(), "ProductGroup1", "ProductGrpDesc", "ProductGrpId", Convert.ToInt32(TxtDescription.Tag.ToString())) != 0)
                {
                    MessageBox.Show("Group Description Already Exist...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    e.Cancel = true;
                    return;
        ...
        private void TxtShortName_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show("Group ShortName Cannot Left Blank...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                e.Cancel = true;
                return;
            }
            else if (_Tag == "NEW")
            {
                if (_objCommon.CheckShortNameDuplicateRecord(TxtShortName.Text.Trim(), "ProductGroup1", "ProductGrpShortName", "ProductGrpId") == 1)
                {
                    MessageBox.Show("Group ShortName Already Exist...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    e.Cancel = true;
                    return;
                }
            }
            ...
            {
                if (_objCommon.CheckShortNameDuplicateRecord(TxtShortName.Text.Trim(), "ProductGroup1", "ProductGrpShortName", "ProductGrpId", Convert.ToInt32(TxtDescription.Tag.ToString())) != 0)
                {
                    MessageBox.Show("Group ShortName Already Exist...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    e.Cancel = true;
                    return;
