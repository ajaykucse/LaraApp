...
{
    public partial class FrmProductGroup2 : Form
    {
        ...
        private void BtnNew_Click(object sender, EventArgs e)
        {
            ...
            Text = "Product Group2 [NEW]";
        }
        private void BtnEdit_Click(object sender, EventArgs e)
        {
            _Tag = "EDIT";
            ControlEnableDisable(false, true);
            Text = "Product Group2 [EDIT]";
        }
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            _Tag = "DELETE";
            ControlEnableDisable(false, false);
            Text = "Product Group2 [DELETE]";
        ...
        private void BtnFirstData_Click(object sender, EventArgs e)
        {
            if (NavMenuDataList.Rows.Count > 0)
            {
                ...
                DataTable dt = _objProductGroup.GetDataProductGroup(Convert.ToInt32(NavMenuDataList.Rows[NavMenuDataRowPosition]["ProductGrpId"].ToString()), "ProductGroup2");
                SetData(dt);
            }
            else
            {
        ...
        private void ClearFld()
        {
            ...
            DataTable DtGodown = _objGodown.GetDataGodown(0);
            CmbGodown.ValueMember = "GodownId";
            CmbGodown.DisplayMember = "GodownDesc";
            CmbGodown.DataSource = DtGodown;
        }
        ...
        private void BtnSearchDesc_Click(object sender, EventArgs e)
        {
            ...
            if (Common.PickList.dt.Rows.Count > 0)
            {
                ...
                {
                    DataTable dt = _objProductGroup.GetDataProductGroup(Convert.ToInt32(frmPickList.SelectedList[0]["ProductGrpId"].ToString().Trim()), "ProductGroup2");
                    SetData(dt);
                    TxtDescription.SelectAll();
                }
                else
		...
		private void CmbGodown_KeyDown(object sender, KeyEventArgs e)
		{
			if (e.KeyData == (Keys.N | Keys.Control))
			{
				...
				CmbGodown.DisplayMember = "GodownDesc";
				CmbGodown.DataSource = DtGodown;
				CmbGodown.Text = frm._NewGodown;
				CmbGodown.Tag = frm._GodownId;
			}
		}
		...
		private void TxtDescription_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                if (_objCommon.CheckDescriptionDuplicateRecord(TxtDescription.Text.Trim(), "ProductGroup2", "ProductGrpDesc", "ProductGrpId") == 1)
                {
                ...
                {
                    TxtShortName.Text = _objCommon.GenerateShortName(TxtDescription.Text.Trim(), "ProductGrpDesc", "ProductGrpShortName", "ProductGroup2");
                }
            }
            else if (_Tag == "EDIT")
            {
                if (_objCommon.CheckDescriptionDuplicateRecord(TxtDescription.Text.Trim(), "ProductGroup2", "ProductGrpDesc", "ProductGrpId", Convert.ToInt32(TxtDescription.Tag.ToString())) != 0)
                {
        ...
        private void TxtShortName_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            {
                if (_objCommon.CheckShortNameDuplicateRecord(TxtShortName.Text.Trim(), "ProductGroup2", "ProductGrpShortName", "ProductGrpId") == 1)
                {
            ...
            {
                if (_objCommon.CheckShortNameDuplicateRecord(TxtShortName.Text.Trim(), "ProductGroup2", "ProductGrpShortName", "ProductGrpId", Convert.ToInt32(TxtDescription.Tag.ToString())) != 0)
                {
                    MessageBox.Show("Product Group ShortName Already Exist...!", "Mr Solution", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    e.Cancel = true;
                    return;
